...
<style scoped>
    * {
    ...
    @font-face {
        ...
        src: url('../../../static/images/icons/iconfont.eot');
        src: url('../../../static/images/icons/iconfont.eot?#iefix') format('embedded-opentype'),
        url('../../../static/images/icons/iconfont.woff2') format('woff2'),
        url('../../../static/images/icons/iconfont.woff') format('woff'),
        url('../../../static/images/icons/iconfont.ttf') format('truetype'),
        url('../../../static/images/icons/iconfont.svg#iconfont') format('svg');
    }
    .icon {
